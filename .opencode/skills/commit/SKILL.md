...
4. **Propose the commit message** — present the structured message to the user in chat and wait for approval or corrections:
...
5. **Commit** — execute `git commit` only after the user approves the message.
