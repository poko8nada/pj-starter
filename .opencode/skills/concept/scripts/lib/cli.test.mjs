...
describe('resolveEditOutDir', () => {
  it('routes draft (muse) to concept/tmp/', () => {
    expect(resolveEditOutDir({ model: 'meta/muse-image', cwd: '/proj' })).toBe('/proj/concept/tmp');
  });

  it('routes photo/illustration to concept/', () => {
