...
// generate.mjs / edit.mjs が共有する I/O 層: API_KEY 検証、/images 呼び出し、レスポンス（usage.cost）取得、画像バイナリ保存、エラー処理（4xx/5xx）。
...
// 下書き => <cwd>/concept/tmp、最終成果物 => <cwd>/concept
export function resolveOutDir({ final: isFinal, cwd }) {
  return isFinal ? path.join(cwd, 'concept') : path.join(cwd, 'concept', 'tmp');
}
